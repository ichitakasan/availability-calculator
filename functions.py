...
def calculate_dailySLA(td_down : timedelta) -> float:
    """
...
def calculate_weeklySLA(td_down : timedelta, week_durations : list[int]) -> float:
    """
...
def calculate_monthlySLA(td_down : timedelta, week_durations : list[int]) -> float:
    """
...
def calculate_quarterlySLA(td_down : timedelta, week_durations : list[int]) -> float:
    """
...
def calculate_yearlySLA(td_down : timedelta, week_durations : list[int]) -> float:
    """
...
def timedelta_to_str(t_delta) -> str:
    ...
    if t_delta.seconds > 0:
        sec_left : int = int(t_delta.seconds)
